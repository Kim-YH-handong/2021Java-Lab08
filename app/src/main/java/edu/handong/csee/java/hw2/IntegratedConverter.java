...
/** This is a client class for converter. */
public class IntegratedConverter {

    private double fromValue;

    /** Make a class IntegratedConverter and call run.
        - Need to input data like 100 km m. */
    ...
    private void run(String[] args) {
        ...
        fromValue = Double.parseDouble(args[0]); // Double.parseDouble converts string into double.
